...
class LspDocumentColorProvider implements monaco.languages.DocumentColorProvider {
    ...
    async provideDocumentColors(
        ...
        const result = await this._client.server.textDocumentDocumentColor({
        ...
        return result.map(colorInfo => ({
            range: this._client.bridge.translateBackRange(translated.textDocument, colorInfo.range).range,
    ...
    async provideColorPresentations(
        ...
        const result = await this._client.server.textDocumentColorPresentation({
            textDocument: translated.textDocument,
        ...
        return result.map(presentation => ({
            ...
            textEdit: presentation.textEdit ? {
                range: this._client.bridge.translateBackRange(translated.textDocument, presentation.textEdit.range).range,
